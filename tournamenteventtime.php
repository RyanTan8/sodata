...
<p><button class='btn btn-primary' id="checkbox-button" onclick='javascript:autoCheckbox()' type='button'><span class='bi bi-clipboard-plus'></span> Automatic checkbox</button></p>
