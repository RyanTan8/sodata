...
//print the time for each event and date
	...
	if($totalEvents)
	{
		...
		exit("<p><button class='btn btn-primary' type='button' onclick='javascript:tournamentEventsAddAll($tournamentID,".$tournamentRow['year'].")'><span class='bi bi-plus-circle'></span> Add all events from this year</button></p>");
	}
